...
class _$UserDocumentReference
  ...
  Future<void> update({
    ...
    final json = {
      ...
      if (age != _sentinel) _$$_UserFieldMap['age']!: age as int,
      if (ageFieldValue != null) _$$_UserFieldMap['age']!: ageFieldValue,
...
class _$UserQuery extends QueryReference<User, UserQuerySnapshot>
  ...
  UserQuery orderByAge({
    ...
    final query = $referenceWithoutCursor.orderBy(_$$_UserFieldMap['age']!,
        descending: descending);
    var queryCursor = $queryCursor;
